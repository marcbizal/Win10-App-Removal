Get-AppxPackage *xboxapp* | Remove-AppxPackage # Xbox App
Get-AppxPackage *3dbuilder* | Remove-AppxPackage # 3DBuilder App
Get-AppxPackage *bingsports* | Remove-AppxPackage # Bing Sports
